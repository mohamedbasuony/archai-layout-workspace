...
_TILE_PAD_RATIO = 0.04  # 4% padding around each tile
_TILE_MIN_SIDE = 64  # minimum crop dimension (px) before upscaling
_TILE_UPSCALE_TARGET = 256  # upscale tiny crops so shortest side >= this
...
def _crop_and_maybe_upscale(
    ...
    """Crop tile from image and upscale if too small."""
    x1, y1, x2, y2 = rect
